...
<!-- Start of main content -->
    ...
    <td width="100%" colSpan=5 valign="top" class=sitename><br/>
        The Australasian Language Technology Workshop 2012   
        <br/>
        <br/>
    ...
    <hr size="1" noshade>
      ...
      <P>
        <h1>ALTA 2012 - Registration of Interest - Feedback</h1>

          <?php
            if ( empty( $result_arg ) ) { 
              echo '<p>Thanks for your submission - unfortunately we have had a problem processing it - please try again.<br/><br/>'; 
              echo 'Please go back to the <a href="http://www.cs.otago.ac.nz/research/conferences/adcs-altw-2012/altaregfrm.php"> registration page</a></p>';
            } else {
